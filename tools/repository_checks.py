...
REQUIRED_PATHS = (
    ...
    "docs/GLOSSARY.md",
    "docs/catalog/schema.yml",
    "docs/catalog/documents.yml",
    "docs/evidence/README.md",
    "docs/evidence/build-record.example.json",
    "docs/handoff/WINDOWS.md",
    "docs/encounters/first-severance/ENCOUNTER_SPEC.md",
    "docs/encounters/first-severance/IMPLEMENTATION_PLAN.md",

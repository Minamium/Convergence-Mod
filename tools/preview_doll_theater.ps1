...
Add-Type -ReferencedAssemblies System.Drawing,System.Drawing.Primitives,System.Drawing.Common,System.Numerics.Vectors,System.Collections,System.Private.Windows.GdiPlus,System.Private.Windows.Core `
    -Path @((Join-Path $dollRepo 'Client/Encounters/FirstSeverance/FirstSeveranceDollPose.cs'),(Join-Path $dollRepo 'Client/Encounters/FirstSeverance/FirstSeveranceDollCapture.cs'),(Join-Path $PSScriptRoot 'DollTheaterPreview.cs'))

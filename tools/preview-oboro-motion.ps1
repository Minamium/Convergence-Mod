...
$work=Join-Path $root '.local/oboro-motion-preview'
New-Item -ItemType Directory -Force -Path $work | Out-Null
$files=@('tools/fixtures/OboroMotionPreview.cs','Client/Weapons/OboroArt.cs','Client/Weapons/SpectralSpriteCutouts.cs','Client/Weapons/OboroSwingPresentation.cs',
    'Content/Items/Oboro/OboroRules.cs','Content/Items/Oboro/OboroComboSettings.cs','Content/Items/Oboro/OboroFirstSwingMotion.cs','Content/Items/Oboro/OboroWire.cs')

...
internal static class FirstSeveranceChoreography
{
    ...
    internal static int FinalHazardTicks(int step) => 240 - Math.Clamp(step / 3, 0, 7) * 8
        + (step / 3 % 2 == 1 ? FirstSeveranceScoreGeometry.SlicerPulses * FirstSeveranceScoreGeometry.SlicerExtraWarningTicks : 0);

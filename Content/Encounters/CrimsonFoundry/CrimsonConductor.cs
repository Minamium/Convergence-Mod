...
public sealed class CrimsonConductor : ModItem, IRaidPedestalKey
{
    ...
    public override string Texture => "Convergence/Assets/Textures/CrimsonFoundry/CrimsonConductor";
    ...
    public override void AddRecipes() => CreateRecipe().AddIngredient(ItemID.Book)
        .AddIngredient(ItemID.Silk, 10).AddIngredient(ItemID.SoulofNight, 3).AddTile(TileID.Bookcases).Register();
}

...
- **Scarlet Invocation — experimental music-led raid.** An NPC-sized scarlet conjurer commands three large apparitions with separate HP. Face each alone until20% HP; then defeat all three survivors and her together. Moving bodies articulate rapid forecast/impact phrases and fills through shared safe corridors. Scarlet Grimoire selects this raid on the shared pedestal. Scarlet Covenant is a ten-slot companion, not a Raid participant. [Encounter guide](docs/encounters/crimson-foundry/ENCOUNTER_SPEC.md).

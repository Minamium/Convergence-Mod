...
- **Crimson Invocation — experimental music-led raid.** An NPC-sized scarlet conjurer commands three large apparitions with separate HP. Defeat them, then face her; dodge field-filling patterns through safe corridors. Crimson Grimoire selects this raid on the shared pedestal. Scarlet Covenant is a ten-slot companion, not a Raid participant. [Encounter guide](docs/encounters/crimson-foundry/ENCOUNTER_SPEC.md).

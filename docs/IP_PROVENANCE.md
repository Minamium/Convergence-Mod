...
On 2026-09-13, two separately supplied local gameplay MP4s were decoded and visually examined through overview, dense and native consecutive frames. [F14](research/WOTG_RAID_BENCHMARK.md#f14--recorded-beam-motion-2026-09-13) separates observed motion from candidate source identities and records the independent all-beam current / sparse forecast-glint revision. This does not retroactively mark the earlier YouTube references as watched. Originals and analysis frames remain local, unmodified/unpublished; no audio assessment, third-party art extraction or recording-to-texture conversion was performed.

...
The 2026-09-13 eight-cast shader prototype uses Luminance's public loading/parameter APIs with an independently authored HLSL material. No Wrath of the Machines/Gods shader or art is copied. [API boundary](encounters/first-severance/VISUAL_SPEC.md#luminance-prototype-boundary) records source/license/version evidence; [Attribution](../Assets/ATTRIBUTION.md#pursuit-prism-shader--2026-09-13) records the runtime export and regeneration recipe. Luminance remains a separately distributed dependency.

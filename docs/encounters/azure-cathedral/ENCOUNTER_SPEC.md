...
Next owner smoke: head-only Duet/floor versus full-body shared-HP Fury; longer diagonal passage and attached volley; cyan cut warning/hit/residue; distant rush → open jaw/slow approach → bite-only silhouette/Fury art; lethal Fury → melting/faded music → re-invocation. Then matching peers, equipped piercing weapons,107% UI/zoom and Reduced Effects. Earlier entrance-mask/music continuity remains unconfirmed. [Current evidence](../../evidence/2026-09-21-azure-fury-refinement.json) separates the two old solo defeats from the new automated/offline checks and pending game acceptance. No release certification is implied.

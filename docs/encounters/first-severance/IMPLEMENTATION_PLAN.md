...
The [native Hurt / authoritative Down](../../adr/0024-native-raid-hurt-and-downed.md) and [ordinary public solo admission](../../adr/0025-public-solo-admission.md) fixes are integrated. The [review disposition](../../research/2026-09-14-implementation-review.md) separates adopted fixes from follow-on clock/DoT/rejoin/reward work; [Status](../../STATUS.md) owns remaining playtests. Preserve accepted art and intentionally absent combat text. Companion party substitution is planned in [Backlog](BACKLOG.md#companion-party-substitution--planned), not included in the admission fix. No new phase, Raid, audio rewrite or whole-fight redesign is implied.

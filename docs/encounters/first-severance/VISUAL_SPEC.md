...
- **Thin axis → fast needle launch → momentary narrow hold → smooth rapid amplification → dark residue** is the shared grammar for every avoidable Doll Raid beam. Forecasts are a continuous roughly one-pixel bright spine with a small soft halo, independent of the final damage width. **No colored forecast volume, opaque rectangle, paired edge rails, arrows or branch-filled slab.** This supersedes the previous full-area warning policy, not the accepted player Stack/Spread circles.
- Initial eight-cast, standalone-Spread pursuit, Final four-color score, lattice, Core jet, Stillness teeth, twin rotation and top/bottom/horizontal jets all use the same original Luminance-managed material. Longitudinal light currents, dark violet depths and a pearl nucleus replace cloudy transverse fill. Red/blue/green/gold keep their assignment and order; cool highlights and shadow tone align them with the purple magic jet without turning every attack purple. Weapons/Oni retain their own presentation.
...
**Material:** independently advected cloud/flow/branch noise creates large convection, faster torn detail and a hot core. The former uniform radiance slab/sine-wire recipe remains rejected. The body quad uses the exact collision half-width with a narrow sampling feather; forecast/live/harmless residue remain separate. Source pressure and short release glare are continuous with the body's flow. Confined lattice/teeth/flood bands have no outside corona; larger source flares are brief decoration, not a new damage region. Reduced Effects keeps all danger footprints while reducing peripheral motes, glare, drift and scene pulses.

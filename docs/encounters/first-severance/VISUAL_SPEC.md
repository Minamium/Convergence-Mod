...
Every Spread adds one brief, tapered white cross at the Boss's mouth, regardless of success or recipient count. It fades within seven ticks, remains local rather than a full-screen flash, and is strongly attenuated by Reduced Effects. Only the endpoint treatment distinguishes impact from dissipation.

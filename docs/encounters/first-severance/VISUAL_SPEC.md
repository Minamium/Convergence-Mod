...
- Lattice lines appear and fire in a rapid scattered order derived from the accepted descriptor. All peers see the same sequence; each line still receives its full warning. Phase-I Stillness retains center-out teeth, never a whole slab flashing early. Confined lattice/teeth/flood bands suppress outside corona so surviving gaps remain legible.

...
- The single Phase-II Core beam uses the same violet flowing ribbon material as Lacuna Testament's sustained beam. A recessed, dark, bevel-edged cut opens **within the rotating metal sphere**: rapid opening, tension hold, pressure widening and continuous resealing. The bright throat graduates into the beam; the full collision corridor remains forecast and faintly covered at the root. No floating muzzle, seal, square-cut bright root or changed damage window. Use a persistent flow phase plus bounded release offset, not elapsed time multiplied by a changing speed that jumps on firing.

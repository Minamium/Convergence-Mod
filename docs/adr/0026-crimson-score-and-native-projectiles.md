...
Public redistribution of the source recording is not inferred from its free-BGM label. [Feature music policy](../encounters/crimson-foundry/ENCOUNTER_SPEC.md#music-and-musical-presentation) keeps the local derivative out of Git pending an explicit distribution basis; this ADR is not a new rights grant.

...
Development source: **0.3.16 / protocol46**. Oboro gains connected anticipation/burst/follow-through, a continuous three-to-one stance handoff and fading violet blade/edge echoes. The live blade and server swept hit test share the changed angular curve; damage, reach, per-cut duration/live window, hit cap, rarity, drop and other weapon effects are retained. Actual equipped DPS is not certified unchanged. Boss AI, wire layout and the integrated0.3.15 slash/body visuals and Doll/Crimson work are unchanged. Use matching0.3.16 peers for the shared motion; the wire layout remains protocol46. The separately published baseline remains [0.3.1 / protocol37](releases/0.3.1.md); no new release is implied.
...
The normal profile still has0.3.15 installed and Convergence remains enabled. Finish0.3.16's isolated package/review, then obtain administrator approval for this change before main integration and normal-profile packaging. After installation, Reload Mods without another Build + Reload. Hold Oboro through repeated1→2→3→1 cycles, stop/restart, reverse aim, dash while cutting, change weapons and compare a matching remote player/Reduced Effects. Check a stationary target at low/high attack speed and compare actual DPS. Existing Boss/terrain/compatibility owner checks remain outstanding.

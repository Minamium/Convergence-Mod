...
- **0.3.4 admission:** [regression/build evidence](evidence/2026-09-14-solo-admission.json) distinguishes the GitHub and Workshop0.3.1 packages and records the corrected checks/install. The owner has not yet confirmed a new successful solo start.

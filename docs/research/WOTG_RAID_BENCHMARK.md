...
### F19 — Vitrion broad worm motion (2026-09-20)

- **Observed video:** owner-provided `Terraria_ Not to be confused with Catastrophe 2026-09-13 19-57-13.mp4`,157.31s. Reviewed20overview samples and82.0–84.75s at4fps: the armored worm leaves the viewport, its long body follows a delayed broad curve, paired blades frame the spine, and the wake follows travel rather than a stationary local wobble. Original video/analysis frames remain local. This is a motion/silhouette observation, not a claim to identify every damage frame from the recording.
- **Primary source:** WoTM `5556a3adcbabffc6fc95685e34f1ee22cee31d9a`, [Hades ExoEnergyBlast](https://raw.githubusercontent.com/LucilleKarma/WrathOfTheMachines/5556a3adcbabffc6fc95685e34f1ee22cee31d9a/Content/NPCs/ExoMechs/Hades/States/SoloAttacks/HadesBodyEternity.ExoEnergyBlast.cs), MIT code (existing source/license inventory above). Large external hover target, limited angular steering, braking/charge and mouth-attached cues precede the beam; steering and acceleration continue through recovery. No code/texture/audio was copied.
- **Independent adoption:** Azure uses a cubic broad-flank windup, full-field locked straight pass, bounded-angle recovery/orbit, longer connected body spacing, dorsal bilateral original art and head-independent world-pass drawing. Paired native HP defeat is unrelated to the visual reference: the[installed tML NPC patch](https://raw.githubusercontent.com/tModLoader/tModLoader/666f69962d3bdffde54fc14025f02634965b4e7c/patches/tModLoader/Terraria/NPC.cs.patch) documents `realLife` forwarding and ModNPC death interception; local logs/source prove an already-defeated chain was still required. They do not prove which native/inter-mod branch first removed that segment.
- **Evidence boundary:** [Azure follow-up evidence](../evidence/2026-09-20-azure-awakening.json) contains sampled production materials and deterministic tests. Native combat motion/readability, networked outcomes and FPS await owner testing; no parity claim with WoTM follows from static code review.

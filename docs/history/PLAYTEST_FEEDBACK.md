...
## Oboro overhead-cut sketch — 2026-09-26 / 0.3.42 → 0.3.47

Owner supplies a new three-cut sketch: overhead diagonal, compact reversal and large spectral finisher, asks for a slightly slower overall rhythm and a sword visible only while attacking. This is a new design request, not measured0.3.42 playtest evidence. Replace the shared curves with22/18/30F, mirror wrist/hand articulation, remove idle/settling sword rendering and distinguish thinner return/heavier finish. Retain damage, drop, buffs and560px reach; total cycle changes60→70F. [Evidence](../evidence/2026-09-27-oboro-kesa-combo.json) separates native/offline checks from user-owned SP/MP input, native player layering and subjective feel.

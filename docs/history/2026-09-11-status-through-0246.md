---
doc_id: history.status-through-0246
...
source_of_truth_for: []
aliases:
  - Status and verification through 0.2.46
related_code: []
related_docs:
  - project.status
  - handoff.windows
...
The [encounter spec](2026-09-11-encounter-evolution.md), [recovery spec](../encounters/first-severance/REVIVE_SPEC.md), [visual spec](2026-09-11-visual-evolution.md) and [audio cues](2026-09-11-audio-evolution.md) own behavior. The [version matrix](../VERSION_MATRIX.md) owns the runtime baseline.
...
[Preserved pre-consolidation record](2026-09-07-pre-consolidation.md) contains the preceding build narrative, original slice plan, old Windows handoff and superseded encounter text, with their original evidence links. Historical “inert” and activation-denied instructions are not current gates.
